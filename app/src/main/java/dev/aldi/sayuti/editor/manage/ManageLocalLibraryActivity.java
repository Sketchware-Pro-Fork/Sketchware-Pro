...
import pro.sketchware.activities.editor.manage.library.repositories.ManageLocalLibrariesRepositoriesActivity;
...
public class ManageLocalLibraryActivity extends BaseAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(
                binding.downloadLibraryButton,
                (view, insets) -> {
                    Insets navigationBarsInsets =
        ...
        adapter.setOnLocalLibrarySelectedStateChangedListener(
                item -> {
        ...
        binding.contextualToolbar.setNavigationOnClickListener(
                v -> hideContextualToolbarAndClearSelection());
        binding.contextualToolbar.setOnMenuItemClickListener(
                item -> {
                    int id = item.getItemId();
                    if (id == R.id.action_select_all) {
                        setLocalLibrariesSelected(true);
                        binding.contextualToolbar.setTitle(
                                String.valueOf(getSelectedLocalLibrariesCount()));
                        return true;
        ...
        binding.downloadLibraryButton.setOnClickListener(
                v -> {
                    if (getSupportFragmentManager().findFragmentByTag("library_downloader_dialog")
                            != null) {
                        return;
                    }
                    ...
                    LibraryDownloaderDialogFragment fragment =
                            new LibraryDownloaderDialogFragment();
                ...
                .addTextChangedListener(
                        new TextWatcher() {
                            ...
                            public void onTextChanged(
                                    CharSequence newText, int start, int before, int count) {}
                        });

        binding.searchBar.setOnMenuItemClickListener(
                item -> {
                    final int id = item.getItemId();
                    if (id == R.id.action_manage_repositories) {
                        startActivity(
                                new Intent(this, ManageLocalLibrariesRepositoriesActivity.class));
                        return true;
                    }
                    return false;
                });
    ...
    private void loadLibraries() {
        ...
        runOnUiThread(
                () -> {
                    ...
                    binding.noContentLayout.setVisibility(
                            localLibraries.isEmpty() ? View.VISIBLE : View.GONE);
                });
    }
    ...
    public class LibraryAdapter extends RecyclerView.Adapter<LibraryAdapter.ViewHolder> {
        ...
        private @Nullable OnLocalLibrarySelectedStateChangedListener
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new ViewHolder(
                    ViewItemLocalLibBinding.inflate(
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            ...
            binding.card.setOnLongClickListener(
                    v -> {
                        ...
                        toggleLocalLibrary(
                                binding.card, library, onLocalLibrarySelectedStateChangedListener);
                        return true;
                    });
        ...
        public void setOnLocalLibrarySelectedStateChangedListener(
                @Nullable
                        OnLocalLibrarySelectedStateChangedListener
                                onLocalLibrarySelectedStateChangedListener) {
            this.onLocalLibrarySelectedStateChangedListener =
                    onLocalLibrarySelectedStateChangedListener;
        }
            ...
            if (library.isSelected() && isUsedLibrary(library.getName())) {
                new MaterialAlertDialogBuilder(ManageLocalLibraryActivity.this)
                        ...
                        .setMessage(
                                "This library \""
                                        + library.getName()
                                        + "\" already used in your project, removing it may break"
                                        + " your project\r"
    ...
    public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            var binding =
                    ViewItemLocalLibSearchBinding.inflate(
                            LayoutInflater.from(parent.getContext()), parent, false);
